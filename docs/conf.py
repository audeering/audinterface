...
# We generate the stub files in a first run
# using a different set of templates
# as we don't want to have automatic TOC entries
# generated by autosummary when building the actual docs
argv = (
    [
        '-o', 'api/',
        '-t', '_templates-stub-files/',
    ]
    + api_dst_files
)
sphinx.ext.autosummary.generate.main(argv)
