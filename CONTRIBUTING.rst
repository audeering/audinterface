...
.. _issue:
    https://gitlab.audeering.com/tools/audinterface/issues/new?issue%5BD=
.. _merge request:
    https://gitlab.audeering.com/tools/audinterface/merge_requests/new
...
newest development version from Gitlab_::
    ...
    git clone git@srv-app-01.audeering.local:tools/audinterface.git
    cd audinterface
    # Use virutal environment
    pip install -r requirements.txt

.. _Gitlab: https://gitlab.audeering.com/tools/audinterface
